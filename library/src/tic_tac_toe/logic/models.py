...
# derived enum; allows comparison of enum members to string values 
# Mark.ENUM == "X" will not evaluate to False always due to addition of "str"
...
@dataclass(frozen=True)     #frozen => immutable data class 
class Move: 
    mark: Mark 
    cell_index: int
